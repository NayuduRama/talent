...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://ramatalentservicesprofile.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
            ...
            success: function (res) {
                ...
                console.log("Hello from Talent profile");
                console.log(talent)
            }.bind(this)
        })
        this.init()
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://ramatalentservicesprofile.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
    ...
    render() {
        ...
        return (
            ...
            //                                    updateProfileData={this.updateWithoutSave}
            //                                    savePhotoUrl='https://ramatalentservicesprofile.azurewebsites.net/profile/profile/updateProfilePhoto'
            //                                />
            //                            </FormItemWrapper>
            //                            <FormItemWrapper
            //                                title='Profile Video'
            ...
            //                                    updateProfileData={this.updateWithoutSave}
            //                                    saveVideoUrl={'https://ramatalentservicesprofile.azurewebsites.net/profile/profile/updateTalentVideo'}
            //                                />
            //                            </FormItemWrapper>
            //                            <FormItemWrapper
            //                                title='CV'
            ...
            //                                    updateProfileData={this.updateWithoutSave}
            //                                    saveCVUrl={'https://ramatalentservicesprofile.azurewebsites.net/profile/profile/updateTalentCV'}
            //                                />
            //                            </FormItemWrapper>
            //                            <SelfIntroduction
